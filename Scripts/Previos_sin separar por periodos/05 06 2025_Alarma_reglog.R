...
#MODELO PREDICTIVO VARIABLE ALARMA (DICOTOMICA)-Regresion logistica ==============================================
library(rsample)
...
test_data$alarma_pred_prob <- predict(modelo_logit, newdata = test_data, type = "response")
test_data$alarma_test <- ifelse(test_data$alarma_pred_prob > 0.5, 1, 0)
